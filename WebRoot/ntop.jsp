        ...
        <div class="container">
            ...
            <c:choose>
             <c:when test="${loginUser == null}">
                <li style="float:left;margin-left:5px;">Hi！欢迎光临</li>
            ...
            <li><a href="<%=basePath %>find/find_main.html">我的订单</a></li>
                ...
                <!-- <li><a class="head-top" href="http://kefu.qycn.com/vclient/chat/?websiteid=112607" target=_blank  title="客服">
					<i class="iconfont icon-kefu" style="display:inline-block;font-size:14px;color:#666;margin-right:3px"></i>客服中心</a>
				</li>
...
<!-- <div class="side-bar"> 
	...
	<p><a href="#"><span class="iconfont icon-dianhua" style="display:inline-block;font-size:20px;color:#fff;margin-right:3px"></span><span style="font-size:12px;line-height:1.4">400-826-4755</span></a></p> 
</div> -->