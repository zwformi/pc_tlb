     ...
     <ul class="member_zi">
       <li>
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
               <tr>
                 <th width="20%"><span class="red_zi">* </span><input type="hidden" id="phone" value="${NEWPHONE }"/>验证码：</th>
                 <td width="80%"><input class="member_box" type="text" name="CODE" id="CODE"> <input class="code_btn" name="fsyzm" id="fsyzm" type="button" value="验证码已发送">
                </td>
               </tr>
               <tr>
                 <td>&nbsp;</td>
                 <td><input class="red_btn" id="next_2" name="next_2" type="button" value="下一步" /></td>
               </tr>
          </table>
       </li>
     </ul>
